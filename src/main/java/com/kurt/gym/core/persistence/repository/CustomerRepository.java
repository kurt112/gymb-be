...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query("select new com.kurt.gym.core.persistence.entity.Customer(e.id, new com.kurt.gym.auth.model.user.User(e.user.firstName,e.user.lastName, e.user.pointsAmount, e.user.cardValue), e.timeIn, e.timeOut, e.membershipDuration) from Customer e where e.timeIn >= CURRENT_DATE")
    Page<Customer> todayCustomer(Pageable pageable);
