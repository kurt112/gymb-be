...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public ResponseEntity<HashMap<String, String>> delete(Employee t) {
        if(isExist(t.getId())  == null) return ApiMessage.errorResponse("Employees deleted successfully");
    ...
    public ResponseEntity<HashMap<String, String>> deleteById(Long id) {
        if(isExist(id)  == null) return ApiMessage.errorResponse("Employee deleted successfully");
